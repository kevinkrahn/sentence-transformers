...
class Transformer(nn.Module):
    ...
    def forward(self, features):
        ...
        feature_names = ["input_ids", "attention_mask", "token_type_ids", "char_input_mask", "word_input_mask"]
        trans_features = { k: features[k] for k in feature_names if k in features }
